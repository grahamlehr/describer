...
import { wireStationLookup } from '/static/stationsearch.js';
...
/** Wire one station card's Station box; the combobox itself is in stationsearch.js. */
function wireLookup(card) {
  wireStationLookup({
    lookup: card.querySelector('[data-station="lookup"]'),
    crsField: card.querySelector('[data-station="crs"]'),
    listbox: card.querySelector('.suggestions'),
    note: card.querySelector('.crs-note'),
    coordsNote: card.querySelector('[data-station="coords-note"]'),
  });
}
    ...
    <div class="override">
      ...
      <div class="override-body" data-body="display" ${entry.display ? '' : 'hidden'}>
        <div class="grid">
          ...
          <label class="check"><input type="checkbox" data-profile="position"
